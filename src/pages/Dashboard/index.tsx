    ...
    async function loadFoods(): Promise<void> {
      ...
      if (selectedCategory && searchValue) {
        response = await api.get(
          `/foods?category=${selectedCategory}&name=${searchValue}`,
        );
      } else if (selectedCategory) {
        response = await api.get(`/foods?category=${selectedCategory}`);
      } else if (searchValue) {
        response = await api.get(`/foods?name=${searchValue}`);
      } else {
      ...
      const foodsResponse = response.data as Food[];
      setFoods(
        foodsResponse.map(foodResponse => {
          return {
            ...foodResponse,
