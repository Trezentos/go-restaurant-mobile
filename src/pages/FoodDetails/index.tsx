...
const FoodDetails: React.FC = () => {
  ...
  useEffect(() => {
    async function loadFood(): Promise<void> {
      ...
      const foodResponse = response.data as Food;
      setFood({
        ...foodResponse,
        price: foodResponse.price * foodQuantity,
        formattedPrice: formatValue(food.price),
      });

      const foodExtras = foodResponse.extras as Extra[];
